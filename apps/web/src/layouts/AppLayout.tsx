...
import { Map, Bell, Route, Truck, Smartphone, Building2, Users, MapPin, Navigation, Radio, Zap, LogOut, Shield, Thermometer, Leaf, PieChart, Settings, ShieldAlert, Key, Cpu } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-[64px] w-full">
            ...
            <div className="flex-auto flex justify-center items-center gap-2 min-w-0 overflow-x-auto no-scrollbar px-2">
              {[
                ...
                ...(isManagerOrOwner || isAdmin ? [{ path: '/motor', label: t('nav.motor') || 'Motor', icon: Cpu, perm: 'view_settings' }] : []),
