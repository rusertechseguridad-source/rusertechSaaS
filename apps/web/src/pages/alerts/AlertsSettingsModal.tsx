...
export const EVENT_TYPES = [
  ...
  { id: 'TOWING', label: 'REMOLQUE / GRÚA DETECTADA' },
  { id: 'DEVICE_DISCONNECT', label: 'DISPOSITIVO DESCONECTADO' },
  { id: 'DEVICE_RECONNECT', label: 'DISPOSITIVO RECONECTADO' },
  { id: 'LOW_BATTERY', label: 'BATERÍA BAJA' },
  { id: 'LOSS_OF_SIGNAL', label: 'PÉRDIDA DE SEÑAL (ZONA CIEGA)' },
  { id: 'SIGNAL_RESTORED', label: 'SEÑAL RESTAURADA' },
  // Telemetry & Sensors
  { id: 'IGNITION_ON', label: 'MOTOR ENCENDIDO (IGNICIÓN)' },
  { id: 'IGNITION_OFF', label: 'MOTOR APAGADO' },
  { id: 'PTO_ON', label: 'TOMA DE FUERZA (PTO) ENCENDIDA' },
  { id: 'PTO_OFF', label: 'TOMA DE FUERZA (PTO) APAGADA' },
  ...
  { id: 'DOOR_2_OPEN', label: 'APERTURA DE PUERTA 2' },
  { id: 'DOOR_2_CLOSE', label: 'CIERRE DE PUERTA 2' },
  { id: 'SENSOR_1_ACTIVE', label: 'SENSOR 1 ACTIVO' },
  { id: 'SENSOR_2_ACTIVE', label: 'SENSOR 2 ACTIVO' },
  { id: 'SENSOR_3_ACTIVE', label: 'SENSOR 3 ACTIVO' },
  // Logistics
  ...
  { id: 'UNAUTHORIZED_STOP', label: 'PARADA NO AUTORIZADA' },
  { id: 'ROUTE_DEVIATION', label: 'DESVÍO DE RUTA' },
  // ADAS / DSM
  ...
  { id: 'SMOKING', label: 'FUMANDO EN CABINA' },
  { id: 'PHONE_USE', label: 'USO DE TELÉFONO' },
  { id: 'HARSH_BUMP', label: 'BACHE / GOLPE BRUSCO' },
  { id: 'ACCIDENT', label: 'POSIBLE ACCIDENTE / VOLCADURA' },
  // Tracking
